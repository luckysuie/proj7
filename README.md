...
| 12 - Azure Functions | Optional Azure Functions façade for semantic search and an alternate deployment boundary for vector search. See the scenario README for details and runtime options. | Azure Functions, .NET Aspire, OpenAI |
